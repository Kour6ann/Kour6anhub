...
function Kour6anHub.CreateLib(title, themeName)
    ...
    -- Registry + helpers for Save/Interface managers
    Window._registry = Window._registry or {}
    Window._tabButtons = Window._tabButtons or {}
    ...
    function Window:SelectTab(tabName)
        -- programmatic tab selection: mirrors the TabButton click behavior
        ...
        for _, t in ipairs(Tabs) do
            if t.Button and t.Button.Text == tabName then
                t.Button:SetAttribute("active", true)
    ...
    -- expose Tabs table for managers
    Window.Tabs = Tabs
